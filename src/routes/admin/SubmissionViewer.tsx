type DrugRelatedProblem = Record<string, unknown> // refine later when you have the schema

export type StudentSubmission = {
  id: number
  synthetic: boolean
  problems: DrugRelatedProblem[]
}
      ...
      <div className="absolute inset-x-0 top-16 mx-auto w-[min(900px,95vw)] rounded-lg bg-white shadow-xl">
        ...
        <div className="px-5 py-4 space-y-3">
          <div className="text-sm text-gray-600">
            Problems: <span className="font-medium text-gray-900">{submission.problems?.length ?? 0}</span>
          </div>
